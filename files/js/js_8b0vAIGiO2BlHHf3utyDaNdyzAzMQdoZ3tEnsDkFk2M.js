...
(function($, Drupal, drupalSettings){
    ...
    $(document).ready(function() {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('custom-js.js DOMContentLoaded');
        });
    });
